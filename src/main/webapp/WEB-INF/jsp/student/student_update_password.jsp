	...
	<div class="col-md-9 col-md-offset-1">
		...
		<table class="show_info" border="1">
			<sf:form method="post" modelAttribute="student"
					 action="${pageContext.request.contextPath }/update_password_database">
				<sf:input path="student_id" type="hidden"/>
				<div class="div-jan"><sf:input path="student_code" type="hidden"/></div>
				<div class="div-jan"><sf:input path="student_name" type="hidden"/></div>
				<div class="div-jan"><sf:input path="student_pwd" type="hidden"/></div>
...
<script type="text/javascript" >
	<%--$("#submit_change").click(function () {--%>
	    <%--var password = "${student.student_pwd}";--%>
