    ...
    <div class="container col-md-10 col-md-offset-1">
        ...
        <table class="show_info" border="1">
            <sf:form method="post" modelAttribute="teacher"
                     action="${pageContext.request.contextPath }/update_teacher_info_database">
                <sf:input path="teacher_id" type="hidden"/>
                <sf:input path="teacher_code" type="hidden" readonly="true"/>
                <sf:errors path="teacher_code" cssClass="error"></sf:errors><br>
                <div class="div-jan">您的姓名:<sf:input path="teacher_name" readonly="true"/></div>
                <sf:errors path="teacher_name" cssClass="error"></sf:errors><br>
                <div class="div-jan">您的电话:<sf:input path="teacher_tel"/></div>
                <sf:errors path="teacher_tel" cssClass="error"></sf:errors><br>
                <div class="div-jan">您的邮箱:<sf:input path="teacher_email"/></div>
