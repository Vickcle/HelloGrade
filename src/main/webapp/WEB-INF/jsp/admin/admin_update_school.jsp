    ...
    <div class="container col-md-10">
        ...
        <table class="show_info" border="1">
            <sf:form method="post" modelAttribute="school"
                     action="${pageContext.request.contextPath }/update_school_database">
                <sf:input path="school_id" type="hidden"/>
                <div class="div-jan">学校编号:<sf:input path="school_code" class=""/></div>
