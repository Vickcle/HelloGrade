...
<script>
    ...
    function getAcademyInfo(){
        $.ajax({
            ...
            success:function(data){
                var academyObjects = data["data"];
                var str = JSON.stringify(academyObjects);
                pushTableInfo(str);
            },
            error:function(){
            }
    ...
    function pushTableInfo(datas) {
        ...
        var tableColumns = [
            ...
            {field: 'academy_address', title: '学校地址',},
            {
                field: 'academy_id',
                title: '操作',
                width: 120,
    ...
    function EditViewById(id){
        window.location.href = "/admin_update_academy?academy_id="+id;
    }
    //进行删除操作
    function DeleteById(id) {
        ...
        var option = {
            ...
            btn: parseInt("0011",2),
            onOk: function(){
                window.location.href = "/delete_academy_database?academy_id="+id;
            }
        }
