        ...
        <div class="table-responsive col-md-10">
            ...
            <c:forEach items="${list}" var="cclass" >
                <tr>
                    ...
                    <td>${cclass.major_id}</td>
                    <td><a href="${pageContext.request.contextPath}/admin_update_class?class_id=${ cclass.class_id}">修改</a></td>
                    <td><a href="${pageContext.request.contextPath}/delete_class_database?class_id=${ cclass.class_id}">删除</a></td>
                </tr>
            </c:forEach>
            </tbody>
            </table>
